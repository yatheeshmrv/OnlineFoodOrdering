...
export const routes: Routes = [
  {
    path: '',
    component: Home,
    title: 'BiteBasket | Online Food Ordering'
  },
  {
    path: 'menu',
    component: Menu,
    title: 'Menu | BiteBasket'
  },
  {
    path: 'login',
    component: Login,
    title: 'Login | BiteBasket'
  },
  {
    path: 'register',
    component: Register,
    title: 'Register | BiteBasket'
  },
  {
    path: 'cart',
    component: Cart,
    canActivate: [authGuard],
    title: 'Cart | BiteBasket'
  },
  {
    path: 'order-confirmation/:orderId',
    component: OrderConfirmation,
    canActivate: [authGuard],
    title: 'Order Confirmation | BiteBasket'
  },
  {
    ...
    title: 'Order Details | BiteBasket'
  },
  {
    path: 'my-orders',
    component: MyOrders,
    canActivate: [authGuard],
    title: 'My Orders | BiteBasket'
  },
  ...
  // Specific Admin routes must appear before /admin.
  {
    ...
    title: 'Manage Food Items | BiteBasket'
  },
  {
    path: 'admin/food-categories',
    component: AdminFoodCategories,
    canActivate: [adminGuard],
    title: 'Manage Food Categories | BiteBasket'
  },
  {
    path: 'admin/orders',
    component: AdminOrders,
    canActivate: [adminGuard],
    title: 'Manage Orders | BiteBasket'
  },
  {
    path: 'admin',
    component: AdminDashboard,
    canActivate: [adminGuard],
    title: 'Admin Dashboard | BiteBasket'
  },
